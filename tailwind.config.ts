		...
		extend: {
			...
			keyframes: {
				...
				'bubble-pop': {
					'0%': {
						opacity: '0',
						transform: 'translateX(-50%) translateY(10px) scale(0.5) rotate(0deg)'
					},
					'50%': {
						opacity: '1',
						transform: 'translateX(-50%) translateY(-4px) scale(1.1) rotate(8deg)'
					},
					'100%': {
						opacity: '1',
			...
			animation: {
				...
				'dog-wiggle': 'dog-wiggle 0.4s ease-in-out'
			}
		}
	},
