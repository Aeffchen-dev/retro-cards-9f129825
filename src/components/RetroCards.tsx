...
import kalleImage from '@/assets/kalle-recreated.png';
          ...
          <div className="flex flex-col items-start w-full h-full">
            ...
            <div className="flex flex-1 w-full items-end justify-start -mb-8 md:-mb-12 relative">
              <div className="relative cursor-pointer" onClick={() => setShowKalleBubble(!showKalleBubble)}>
                {showKalleBubble && (
                  <div className="absolute top-[-16px] left-[calc(50%+44px)] bg-black text-white px-3 py-1.5 rounded-[16px] whitespace-nowrap text-sm animate-bubble-pop">
